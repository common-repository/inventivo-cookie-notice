...
define('INVENTIVO_COOKIE_NOTICE_CURRENT_VERSION', '1.0.2' );
...
class InvCookieSettingsPage
{
                ...
                <div class="hreflang-x-default-tag-for-wpml-inventivo-wrapper">
                    <div class="hreflang-x-default-tag-for-wpml-inventivo-element">
                        <a href="https://www.inventivo.de/en/the-x-default-tag-in-wpml-is-missing-what-now#pluginkaufen" target="_blank">
                            <img src="' . plugins_url() . '/inventivo-cookie-notice/admin/images/icon-256x256-1.png" />
                        </a>
                    </div>
                    <div class="hreflang-x-default-tag-for-wpml-inventivo-element">
                        <h2>Hey Dude!</h2>
    ...
    public function inv_admin_style() {
        wp_enqueue_style('admin-styles', plugins_url().'/inventivo-cookie-notice/admin/css/admin-styles.css');
    }
